...
import LineChart from '@/modules/dashboard/components/charts/LineChart04';
  ...
  const chartData = {
    ...
    datasets: [
      // Indigo line
      {
        ...
        fill: true,
        backgroundColor: `rgba(${hexToRGB(tailwindConfig().theme.colors.blue?.[500]?? '#3B82F6')}, 0.08)`,
        borderColor: tailwindConfig().theme.colors.indigo?.[500] ??'#6574cd',
        borderWidth: 2,
        tension: 0,
        pointRadius: 0,
        pointHoverRadius: 3,
        pointBackgroundColor: tailwindConfig().theme.colors.indigo?.[500]?? '#6574cd',
        clip: 20,
      },
    ],
  };
